...
public class ForgetCountDownTimerUtils extends CountDownTimer {
    private TextView mButton;

    private Context mContext;

    public ForgetCountDownTimerUtils(TextView button, Context context) {
        //控件，定时总时间,间隔时间
        super(60000, 1000);
        this.mButton = button;
    ...
    public ForgetCountDownTimerUtils(TextView button, long millisInFuture, long countDownInterval) {
        //控件，定时总时间,间隔时间
