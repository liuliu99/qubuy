...
public final class DialogUtil {
    ...
    public static void setDialogWindowAttr(Dialog dlg, int width, int height) {
        setDialogWindowAttr(dlg, width, height, Gravity.CENTER, 0);
    }

    //在dialog.show()之后调用
    public static void setDialogWindowAttr(Dialog dlg, int width, int height, int gravity, @StyleRes int animResId) {
