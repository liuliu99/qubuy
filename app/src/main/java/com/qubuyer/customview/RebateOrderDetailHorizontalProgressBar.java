...
public class RebateOrderDetailHorizontalProgressBar extends View {
     ...
     * 进度条颜色
     */
    private int progressColor = 0xFFFF9333;
    ...
    public RebateOrderDetailHorizontalProgressBar(Context context) {
        super(context);
    }

    public RebateOrderDetailHorizontalProgressBar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
        initPaint();
    }
...
//        bgRectF.top = tipHeight + progressMarginTop;
//        bgRectF.right = getWidth();
//        bgRectF.bottom = tipHeight + progressMarginTop;
...
//        progressRectF.top = tipHeight + progressMarginTop;
//        progressRectF.right = currentProgress;
//        progressRectF.bottom = tipHeight + progressMarginTop;
//        canvas.drawRoundRect(progressRectF, roundRectRadius, roundRectRadius, progressPaint);
    ...
    private void drawText(Canvas canvas, String textString) {
        ...
        //文字绘制到整个布局的中心位置
        canvas.drawText("折让" + textString + "%", textRect.centerX(), baseline, textPaint);
    }
...
//                textString = formatNum(format2Int(value));
     ...
     * @return
     */
    public RebateOrderDetailHorizontalProgressBar setProgressWithAnimation(float progress) {
        mProgress = progress;
        initAnimation();
        return this;
    }
     ...
     * @return
     */
    public RebateOrderDetailHorizontalProgressBar setCurrentProgress(float progress) {
        mProgress = progress;
    ...
    public RebateOrderDetailHorizontalProgressBar setCurrentProgressText(String textString) {
     ...
     * @return
     */
    public RebateOrderDetailHorizontalProgressBar setProgressListener(ProgressListener listener) {
