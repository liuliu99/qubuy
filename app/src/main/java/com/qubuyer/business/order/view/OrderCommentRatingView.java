...
public class OrderCommentRatingView implements IRatingView {
    ...
    public void setCurrentState(int state, int position, int starNums) {
        ...
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(ConvertUtils.dp2px(16), ConvertUtils.dp2px(16));
