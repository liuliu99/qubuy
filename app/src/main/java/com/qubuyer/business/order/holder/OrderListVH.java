...
public class OrderListVH extends RecyclerView.ViewHolder {
    ...
    public TextView tv_right_four_btn;
    public TextView tv_right_three_btn;
    ...
    public OrderListVH(View itemView) {
        ...
        tv_right_four_btn = itemView.findViewById(R.id.tv_right_four_btn);
        tv_right_three_btn = itemView.findViewById(R.id.tv_right_three_btn);
