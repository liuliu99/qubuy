...
public class HomeCategoryPagerAdapter extends PagerAdapter {
    ...
    private List<HomeCategoryViewPage> mPageList;

    public HomeCategoryPagerAdapter(Context mContext, List<HomeCategoryViewPage> pageList) {
        this.mContext = mContext;
        this.mPageList = pageList;
    }

    public List<HomeCategoryViewPage> getPageList() {
        return mPageList;
    }
