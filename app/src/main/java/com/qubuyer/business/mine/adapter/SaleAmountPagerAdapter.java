 ...
 * @description 订单列表PageAdapter
 & @version
 */
public class SaleAmountPagerAdapter extends PagerAdapter {
    private Context mContext;
    private List<SaleAmountViewPage> mPageList;

    public SaleAmountPagerAdapter(Context mContext, List<SaleAmountViewPage> pageList) {
        this.mContext = mContext;
        this.mPageList = pageList;
    }

    public List<SaleAmountViewPage> getPageList() {
        return mPageList;
    }
