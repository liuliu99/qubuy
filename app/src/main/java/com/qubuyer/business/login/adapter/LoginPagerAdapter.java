package com.qubuyer.business.login.adapter;
 ...
 * @author Susong
 * @description 登录 PageAdapter
 & @version
 */
public class LoginPagerAdapter extends PagerAdapter {
    private Context mContext;
    private List<LoginBaseViewPage> mPageList;

    public LoginPagerAdapter(Context mContext, List<LoginBaseViewPage> pageList) {
        this.mContext = mContext;
        this.mPageList = pageList;
    }

    public List<LoginBaseViewPage> getPageList() {
        return mPageList;
    }
