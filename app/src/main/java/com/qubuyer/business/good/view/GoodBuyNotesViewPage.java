 ...
 * @description 商品购买须知页
 */
public class GoodBuyNotesViewPage extends GoodDetailBaseViewPage implements IGoodDetailView {
    //当前上下文
    ...
    public GoodBuyNotesViewPage(Context mContext, String goodId) {
    ...
    public View getView() {
        if (mView == null) {
            ...
            webView.loadUrl(NetConstant.BASE_URL + "/home/html/purchaseNotice");
