...
public class AddressPickerView extends RelativeLayout implements View.OnClickListener {
    ...
    private int defaultSelectedColor = Color.parseColor("#E95513");
    ...
    // 确定字体可以点击时候的颜色
    private int defaultSureCanClickColor = Color.parseColor("#E95513");
...
//                initData();
    ...
    private void cancel() {
        //   回调接口
        if (mOnAddressPickerSureListener != null) {
            mOnAddressPickerSureListener.onCancel();
        }
    }
                ...
                public void onClick(View v) {
                    ...
                    switch (tabSelectPosition) {
                        case 0:
                            ...
                            mTabLayout.getTabAt(1).setText("请选择");
                        ...
                        case 1:
                            ...
                            mSelectDistrict = null;
                            mSelectDistrictPosition = 0;
                            mTabLayout.getTabAt(2).setText("请选择");
                            // 设置这个对应的标题
